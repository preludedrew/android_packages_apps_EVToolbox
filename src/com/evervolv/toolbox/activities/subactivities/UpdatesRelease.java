...
public class UpdatesRelease extends SettingsFragment implements OnPreferenceChangeListener {

    private static final String TAG = "EVToolbox";
    
    private static final String SCHEDULE_PREF = "pref_updates_release_schedule";
